...
import com.example.chattapp.databinding.ItemContainerReceivedMessageBinding;
import com.example.chattapp.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       if (viewType == VIEW_TYPE_SENT) {
           return new SenmessageViewHolder(
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == VIEW_TYPE_SENT) {
            ((SenmessageViewHolder) holder).setData(chatMessages.get(position));
        } else {
    ...
    static class SenmessageViewHolder extends RecyclerView.ViewHolder {
        private final ItemContainerSentMessageBinding binding;
        SenmessageViewHolder(ItemContainerSentMessageBinding itemContainerSentMessageBinding) {
